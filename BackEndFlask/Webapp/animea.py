...
class AnemiaForm(FlaskForm):
    Sex = IntegerField('The gender (0 or 1) ', validators=[DataRequired()])
    ...
    def checkAnemia(self, Sex, Red_Blood_Cell, White_Blood_Cell, Platelets, Hemoglobin):
        test1 = Sex ==1 and 4000000.0 <= Red_Blood_Cell <=5000000.0 and 4000.0 <= White_Blood_Cell <=11000.0 and 150000.0<= Platelets <=400000.0 and 11.0<= Hemoglobin <=16.0
        test2 = Sex ==0  and 3650000.0 <= Red_Blood_Cell <=4500000.0 and 4000.0 <= White_Blood_Cell <=11000.0 and 150000.0<= Platelets <=400000.0 and 10.0<= Hemoglobin <=15.0
        test3 = Sex ==1 and Red_Blood_Cell <4000000.0 and Hemoglobin<11.0
        test4 = Sex ==0 and Red_Blood_Cell <4650000.0 and Hemoglobin<10.0
